...
public class MemberController {
	...
	public String loginView(@ModelAttribute("MemberDTO") MemberDTO memberDTO, HttpServletRequest request,
			HttpServletResponse response, ModelMap model) throws Exception {
		return "/member/login";
	}
	...
	public String actionLigin(@ModelAttribute("MemberDTO") MemberDTO memberDTO, HttpServletRequest request,
	...
	public String homeView(@ModelAttribute("MemberDTO") MemberDTO memberDTO, Model model,
